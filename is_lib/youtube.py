...
CLIENT_SECRETS_FILE = os.path.join(settings.DATA_DIR, 'client_secret.json')
CREDENTIALS_FILE = os.path.join(settings.DATA_DIR, 'credentials.storage')
...
def playlist_item_insert(tutorial, playlist):
